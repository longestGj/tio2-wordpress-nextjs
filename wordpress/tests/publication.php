...
function tio2_assert_public_route_inventory(): void
{
    ...
    $expected_routes = [
        'tio2-a' => ['expectedPublicUrls' => 1, 'path' => '/', 'template' => 'site-a-homepage-brand-v0.3'],
    ...
    foreach ([
        '{"version":"root-only-v0.1","sites":{"tio2-a":{"expectedPublicUrls":1,"routes":[{"path":"/","template":"site-a-homepage-brand-v0.3"}]}}}',
        '{"version":"root-only-v0.1","sites":{"tio2-a":{"expectedPublicUrls":1,"routes":[{"path":"products","template":"site-a-homepage-brand-v0.3"}]},"tio2-b":{"expectedPublicUrls":1,"routes":[{"path":"/","template":"site-b-homepage-v0.1-frozen"}]}}}',
        '{"version":"root-only-v0.1","sites":{"tio2-a":{"expectedPublicUrls":2,"routes":[{"path":"/","template":"site-a-homepage-brand-v0.3"},{"path":"/","template":"site-a-homepage-brand-v0.3"}]},"tio2-b":{"expectedPublicUrls":1,"routes":[{"path":"/","template":"site-b-homepage-v0.1-frozen"}]}}}',
        ...
        '{"version":"root-only-v0.1","sites":{"tio2-a":{"expectedPublicUrls":2,"routes":[{"path":"/","template":"site-a-homepage-brand-v0.3"}]},"tio2-b":{"expectedPublicUrls":1,"routes":[{"path":"/","template":"site-b-homepage-v0.1-frozen"}]}}}',
    ] as $invalid_json) {
        try {
