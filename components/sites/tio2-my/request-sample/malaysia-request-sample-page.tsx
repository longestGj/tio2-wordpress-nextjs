...
import {MalaysiaRequestSampleFaq} from './malaysia-request-sample-faq'
...
export function MalaysiaRequestSamplePage({page,prefill,receiverReady,structuredData}:{readonly page:MalaysiaRequestSamplePageDto;readonly prefill:MalaysiaSamplePrefill;readonly receiverReady:boolean;readonly structuredData:ReactNode}){
  return <div className={styles.site} data-site-scope="tio2-my" data-page-id="CONV-SAMPLE"><MalaysiaGlobalHeader chrome={page.globalChrome} currentPageId="CONV-SAMPLE" sourcePageId="CONV-SAMPLE"/><main className={styles.main}>
    ...
    <MalaysiaRequestSampleForm page={page} prefill={prefill} receiverReady={receiverReady}/>
    ...
    <section className={styles.faq} data-module="faq" aria-labelledby="sample-faq-heading"><div><p className={styles.eyebrow}>{page.faq.eyebrow}</p><h2 id="sample-faq-heading">{page.faq.heading}</h2><p>{page.faq.intro}</p></div><MalaysiaRequestSampleFaq items={page.faq.items}/></section>
