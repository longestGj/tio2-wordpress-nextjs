...
function Complete-PrereleaseEvidence {
    ...
    $result = [ordered]@{
        ...
        requiredChecks = $(if ($Action -eq 'TestLiveForms') { @('direct_provider', 'thank_you', 'one_post_per_workflow', 'no_blocked_writes') } else { @('chromium', 'axe', 'keyboard', 'visible_focus', 'public_paths', 'internal_links_59', 'no_horizontal_overflow', 'back_return_state', 'five_application_public_metadata') })
