...
describe('MARKET-000 sitemap release control', () => {
  it('keeps /markets out of the controlled sitemap before release authorization', async () => {
    ...
    expect(sitemap).toEqual([{
      ...
      lastModified: new Date('2026-08-31T01:02:03.000Z'),
    }])
    expect(JSON.stringify(sitemap)).not.toContain('/markets')
