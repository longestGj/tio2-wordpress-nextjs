...
describe('independent five-page common-core review',()=>{
 it('keeps all nine prior contracts byte-equivalent as parsed data and their old metadata behavior',()=>{
  ...
  for(const id of oldIds){
   ...
   expect(buildEditorialMetadata(getSiteConfig('tio2-my'),page).alternates?.canonical).toBe(prior.seo.canonical)
  }
 })
