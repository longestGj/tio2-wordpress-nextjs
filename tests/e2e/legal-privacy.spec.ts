...
test('Cookie inventory reflows without horizontal scrolling and remains readable at 200%', async ({page}) => {
  ...
  await page.screenshot({path: `${evidenceDirectory}/cookie-policy-200-percent.png`, fullPage: true, animations: 'disabled'})
})
