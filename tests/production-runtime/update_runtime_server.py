...
def package():
    ...
    proof={'schemaVersion':'tio2-production-proof-v1','contractVersion':'tio2-production-contracts-v1','siteId':'tio2-my','commit':manifest['commit'],'archiveSha256':manifest['archiveSha256'],'manifestSha256':entry(path)['sha256'],'source':{'branch':'main','clean':True},'prerelease':{'state':'HEALTHY','siteId':'tio2-my','commit':manifest['commit'],'completedAt':'2026-09-11T00:00:00Z','buildId':'fixture-B','cmsIdentitySha256':'d'*64,'receiptSha256':'e'*64}}
