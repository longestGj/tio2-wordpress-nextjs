...
class UpdateRehearsal(Rehearsal):
    ...
    def prepare(self):
        ...
        (ROOT/'.superpowers/sdd/2026-09-11-release-tooling-revised/task-3-fixture-normalization.json').write_text(json.dumps({'runId':self.run_id,'scope':'own clone before enrollment only','originalReadOnlyRfqCRLFCount':118,'changes':self.contract_normalization},indent=2))
