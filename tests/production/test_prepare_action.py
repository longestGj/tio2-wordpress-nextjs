...
def create_package(paths):
    ...
    proof={'schemaVersion':'tio2-production-proof-v1','contractVersion':'tio2-production-contracts-v3','siteId':'tio2-my','commit':manifest['commit'],'archiveSha256':manifest['archiveSha256'],'manifestSha256':hashlib.sha256(manifest_path.read_bytes()).hexdigest(),'source':{'branch':'main','clean':True},'prerelease':{'state':'PASSED','siteId':'tio2-my','commit':manifest['commit'],'runId':'fixture-run','sealedAt':'2026-09-11T00:00:00Z','buildId':'fixture-build-B','cmsIdentitySha256':'d'*64,'releaseSurfaceSha256':manifest['releaseSurfaceSha256'],'counts':{'businessPages':57,'registeredObjects':59,'widths':3,'browserCases':177},'forms':{'rfq':'RECEIVED','sample':'RECEIVED','documents':'RECEIVED'},'productionGateReceiptSha256':'e'*64}}
