...
describe('tio2-my production runtime topology', () => {
  ...
  it('builds and runs the Next.js image with pinned inputs and a non-root runtime', () => {
    ...
    expect(dockerfile).toContain('ARG NEXT_PUBLIC_TIO2_MY_GTM_CONTAINER_ID')
    expect(dockerfile).toContain('ARG NEXT_PUBLIC_TIO2_MY_GA4_MEASUREMENT_ID')
    ...
    expect(dockerfile).toContain('NEXT_PUBLIC_TIO2_MY_GTM_CONTAINER_ID=${NEXT_PUBLIC_TIO2_MY_GTM_CONTAINER_ID}')
    expect(dockerfile).toContain('NEXT_PUBLIC_TIO2_MY_GA4_MEASUREMENT_ID=${NEXT_PUBLIC_TIO2_MY_GA4_MEASUREMENT_ID}')
