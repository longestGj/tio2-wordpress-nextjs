export interface EditorialContract {
  readonly identity: {readonly pageId:string; readonly siteScope:'tio2-my'; readonly locale:'en'; readonly path:string; readonly section:'resources'|'applications'; readonly provisional:boolean; readonly schemaVersion:'editorial-v0.1'}
