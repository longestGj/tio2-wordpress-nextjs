export interface MalaysiaResourceOriginArticleMetadata {
...
function publicMetadata(value: unknown): MalaysiaResourceOriginArticleMetadata | null {
...
export function projectApprovedMalaysiaResourceOriginArticleMetadata(
  value: unknown,
): MalaysiaResourceOriginArticleMetadata | null {
  if (!value || typeof value !== 'object' || Array.isArray(value)) return null
  const item = value as UnknownRecord
...
export function resolveVisibleMalaysiaResourceOriginArticleMetadata(
  schemaMode: unknown,
  value: unknown,
): MalaysiaResourceOriginArticleMetadata | null {
