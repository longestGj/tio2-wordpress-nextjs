...
export type GetMalaysiaDocumentsHubQueryVariables = Exact<{ [key: string]: never; }>;


export type GetMalaysiaDocumentsHubQuery = { readonly malaysiaDocumentsHubRecordJson: string };
...
export const GetMalaysiaDocumentsHubDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetMalaysiaDocumentsHub"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"malaysiaDocumentsHubRecordJson"}}]}}]} as unknown as DocumentNode<GetMalaysiaDocumentsHubQuery, GetMalaysiaDocumentsHubQueryVariables>;
