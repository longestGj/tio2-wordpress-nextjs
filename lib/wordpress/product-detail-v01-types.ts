...
export interface MalaysiaProductDetailModules {
  ...
  readonly technical: {readonly eyebrow: string; readonly heading: string; readonly intro: string; readonly sourceLabel: string; readonly columns: readonly string[]; readonly rows: readonly ProductDetailTechnicalRow[]; readonly footnote?: string; readonly note: string; readonly action?: ProductDetailAction}
