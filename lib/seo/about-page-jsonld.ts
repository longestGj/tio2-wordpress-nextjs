    ...
    '@graph': [
      {
        ...
        name: page.seo.openGraphTitle, description: page.seo.description, inLanguage: page.seo.language,
      ...
      },
      {
        ...
        description: page.schema.organizationDescription, url: site.url,
        brand: {'@id': brandId}, location: {'@id': placeId},
