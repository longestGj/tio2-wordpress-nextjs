...
function normalizeDetail(
  ...
  return markValidated({
    ...
    presentation: {
      ...
      technicalData: {
        ...page.presentation.technicalData,
        headers: {...page.presentation.technicalData.headers},
      },
      fitCheck: {...page.presentation.fitCheck},
      formulationPriorities: {...page.presentation.formulationPriorities},
      validation: {...page.presentation.validation},
      applicationContext: {...page.presentation.applicationContext},
      enquiryPreparation: {...page.presentation.enquiryPreparation},
      faq: {...page.presentation.faq},
      related: {
        ...page.presentation.related,
        productDescriptions: [...page.presentation.related.productDescriptions],
        resourceDescriptions: [...page.presentation.related.resourceDescriptions],
      },
      finalCta: {...page.presentation.finalCta},
      disclaimerLabel: page.presentation.disclaimerLabel,
      footerDescription: page.presentation.footerDescription,
    },
    decisionRail: page.decisionRail.map((item) => ({...item})),
