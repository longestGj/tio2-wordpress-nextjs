...
REQUIRED_FILES = (
    ...
    "adoption_contract.py", "adoption_probe.py", "adoption_state.py", "adoption_apply.py", "adoption_phase_a.py", "adoption_wordpress.py", "adoption_internal.py", "adoption_tls.py", "tio2_adopt.py", "tool-commit.txt",
    "root-adopt.sh",
)
