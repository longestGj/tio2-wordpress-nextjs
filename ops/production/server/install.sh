...
for source_file in install.sh bootstrap_install.py bootstrap_selftest.py tio2_release.py release_contract.py release_state.py sudoers.tio2-release sshd-tio2-production.conf; do
